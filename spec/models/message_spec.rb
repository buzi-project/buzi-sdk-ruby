...
# Unit tests for Buzi::V1::Message
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Buzi::V1::Message do
  let(:instance) { Buzi::V1::Message.new }

  describe 'test an instance of Message' do
    it 'should create an instance of Message' do
      expect(instance).to be_instance_of(Buzi::V1::Message)
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["PENDING", "REJECTED"])
  ...
  describe 'test attribute "inbox"' do
    it 'should work' do
      ...
      # validator.allowable_values.each do |value|
      #   expect { instance.inbox = value }.not_to raise_error
      # end
    end
  end
